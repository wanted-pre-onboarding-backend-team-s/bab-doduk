...
public enum ErrorType {
    ...
    U002("U002", "이미 존재하는 계정명입니다.", DuplicatedUsernameException.class, HttpStatus.CONFLICT),
    U003("U003", "비밀번호 확인이 일치하지 않습니다.", MismatchedReconfirmPasswordException.class, HttpStatus.BAD_REQUEST),
